param(
    ...
    [double]$CompressionGridRegWeight = 0.0,
    [double]$CompressionRank1RegWeight = 0.0,
    [double]$CompressionScaleRegWeight = 0.0,
...
$env:COMPRESSION_GRID_REG_WEIGHT = $CompressionGridRegWeight.ToString([System.Globalization.CultureInfo]::InvariantCulture)
$env:COMPRESSION_RANK1_REG_WEIGHT = $CompressionRank1RegWeight.ToString([System.Globalization.CultureInfo]::InvariantCulture)
$env:COMPRESSION_SCALE_REG_WEIGHT = $CompressionScaleRegWeight.ToString([System.Globalization.CultureInfo]::InvariantCulture)
