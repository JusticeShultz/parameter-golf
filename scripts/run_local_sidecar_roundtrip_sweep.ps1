...
if ([string]::IsNullOrWhiteSpace($SweepId)) {
    $SweepId = "sidecarrtsweep_" + (Get-Date -Format "yyyyMMdd_HHmmss")
}
...
$experiments = @(
    @{ Suffix = "c0015_b0020_s8";  CacheMix = "0.015"; BigramMix = "0.02"; CacheSize = "8"  },
    @{ Suffix = "c0020_b0020_s8";  CacheMix = "0.02";  BigramMix = "0.02"; CacheSize = "8"  },
    @{ Suffix = "c0020_b0030_s8";  CacheMix = "0.02";  BigramMix = "0.03"; CacheSize = "8"  },
    @{ Suffix = "c0020_b0020_s16"; CacheMix = "0.02";  BigramMix = "0.02"; CacheSize = "16" }
)
