...
if ([string]::IsNullOrWhiteSpace($SweepId)) {
    $SweepId = "sidecarrefine_" + (Get-Date -Format "yyyyMMdd_HHmmss")
}
...
$experiments = @(
    @{ Suffix = "c0018_b0030_s8"; CacheMix = "0.018"; BigramMix = "0.030"; CacheSize = "8" },
    @{ Suffix = "c0020_b0028_s8"; CacheMix = "0.020"; BigramMix = "0.028"; CacheSize = "8" },
    @{ Suffix = "c0020_b0030_s8"; CacheMix = "0.020"; BigramMix = "0.030"; CacheSize = "8" },
    @{ Suffix = "c0020_b0032_s8"; CacheMix = "0.020"; BigramMix = "0.032"; CacheSize = "8" },
    @{ Suffix = "c0022_b0030_s8"; CacheMix = "0.022"; BigramMix = "0.030"; CacheSize = "8" }
)
